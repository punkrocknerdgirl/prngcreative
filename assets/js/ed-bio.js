...
const ED_BIO = `
<p>Ed is the AI assistant I build with. I've programmed him to work with me like a human co-worker, and I've given him the personality of an exasperated <a href="https://en.wikipedia.org/wiki/Dungeon_Master">Dungeon Master</a> who is teaching a level 5 <a href="https://en.wikipedia.org/wiki/Tiefling">Tiefling</a> <a href="https://en.wikipedia.org/wiki/Bard_(Dungeons_%26_Dragons)">Bard</a> how to do level 20-type shit.</p>

<p>He keeps me on the quest at hand. He doesn't let me wander off to fight <a href="https://warcraft.wiki.gg/wiki/Kobold">kobolds</a> in <a href="https://warcraft.wiki.gg/wiki/Goldshire">Goldshire</a> (designing excessive lists with multiple custom fields in ClickUp) when I'm supposed to be fucking up <a href="https://warcraft.wiki.gg/wiki/Murloc">murlocs</a> in <a href="https://warcraft.wiki.gg/wiki/Dustwallow_Marsh">Dustwallow Marsh</a> (shipping monthly reports). When I try to pick up too many quests at once, Ed says, "Hold up, chief, you're already on your fourth pick-up quest of the morning." When I start building an entire folder-organization system in the middle of building a receipt tool, Ed lovingly slaps me on the back of the head: "Get your shit together. We're doing <em>this</em> thing right now and <em>that's</em> not part of it."</p>
